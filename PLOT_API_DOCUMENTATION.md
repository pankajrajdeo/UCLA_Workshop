...
This document provides API class-like documentation for each plot type defined in the provided Python code within the [figure_generation.py](./figure_generation.py) script, detailing required and optional variables, their types, and descriptions based on standard practices.
---
